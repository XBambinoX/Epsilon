...
public static class Simplifier
{
    ...
    private static Expr SimplifyOnce(Expr expr)
    {
        Expr simplified = expr switch
        {
            ...
            Asinh(var a) => new Asinh(a.Simplify()),
            Acosh(var a) => new Acosh(a.Simplify()),
            Atanh(var a) => new Atanh(a.Simplify()),
            Coth(var a) => new Coth(a.Simplify()),
            Sech(var a) => new Sech(a.Simplify()),
